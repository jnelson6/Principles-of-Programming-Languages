...
let is_num_help : exp_val -> bool ea_result =  function
...
(*
*
* P1. check my correctness -  MINE
* gets member out of record
*)
  | Proj(e,id) ->
    eval_expr e >>=             
...
(*
*
* P2. NEED to implement 
* record expression , id to update , and new val -> cant update unmutable 
e1 - gstore
*)
  | SetField(e1,id,e2) ->
    eval_expr e2 >>= fun x ->
    ...
    | None -> error "Field not declared"
    | Some(_,RefVal id) -> Store.set_ref g_store id x >>= fun _ -> return UnitVal
    | _ -> error "failed to set field of non mutable field"
    
    )
  
(*
* 
* P3.  NEED to implement 
* boolean if numb
*)
